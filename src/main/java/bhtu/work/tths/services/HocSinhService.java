...
public class HocSinhService {
    ...
    public int getPhanThuongDaTrao (TieuChi loaiMa) throws SQLException {
        int result = 0;
...
//    public boolean themPhanThuong(String ten, String maHK, String danhHieu) {return false;}
//    public boolean themPhanThuong(PhanThuong phanThuong) {
//        return false;
//    }

    public  int getVoDaPhat() throws SQLException {
        int voDaPhat;
        StringBuilder sqlQuery = new StringBuilder();
    ...
    public  int getVoChuaPhat() throws SQLException {
        int voChuaPhat;
        StringBuilder sqlQuery = new StringBuilder();
        sqlQuery.append("SELECT SUM(soVo)\n" +
                "FROM (\tSELECT phan_thuong.idHocSinh, phan_thuong.dotPhatThuong, phan_thuong.danhHieu, muc_trao_thuong.soVo \n" +
    ...
    public  List<PhanThuongHK> getPTHK(String filter) throws SQLException {
    ...
    public List<PhanThuongDot> getPTDot(String filter) throws SQLException {
    ...
    public  List<PhanThuong> getThuong(String maHS) throws SQLException {
